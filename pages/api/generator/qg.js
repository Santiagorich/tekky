...
module.exports = allowCors(async(req, res) => {
    ...
    var config = {
        method: 'post',
        url: `http://localhost:3000/api/generator/querifySpec?url=${encodedurl}&prod=${encodedprod}`,
        headers: {}
    };
    ...
    var config = {
        method: 'post',
        url: `http://localhost:3000/api/generator/getter?url=${encodeURIComponent(selobj["queryableurl"])}&query=${encodedquery}&contsel=${selobj["contsel"]}&namesel=${selobj["namesel"]}&pricesel=${selobj["pricesel"]}&imgsel=${selobj["imgsel"]}`,
        headers: {}
    };
    if (req.query.query) {
