...
function StoreSearchInput() {
  return (
    <div className='flex border-2 rounded-sm px-2 bg-white max-w-fit'>
        ...
        <input type="text" className='p-1 px-4 text-sm rounded-sm focus:outline-none bg-transparent' placeholder='Buscar tiendas...'/>
    </div>
  )
}
